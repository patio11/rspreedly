module RSpreedly
  ...
  class Subscriber < Base
    ...
    def subscribe_link(subscription_plan_id, screen_name, return_url=nil)
      ...
      "https://subs.pinpayments.com/#{RSpreedly::Config.site_name}/subscribers/#{self.customer_id}/subscribe/#{subscription_plan_id}/#{screen_name}#{params}"
    end

    def subscription_link(return_url=nil)
      params = return_url.nil? ? "" : "?return_url=" + return_url
      "https://subs.pinpayments.com/#{RSpreedly::Config.site_name}/subscriber_accounts/#{self.token}#{params}"
    end
    ...
    def to_xml(opts={})
      ...
      exclude = [
        ...
        :invoices,     :subscription_plan,          :payment_account_display,
        :payment_account_on_file
      ]
